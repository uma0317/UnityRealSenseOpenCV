...
//public sealed class ProcessingBlockDataAttribute2 : System.Attribute
//{
...
[Serializable]
public class RsProcessingPipe2 : RsFrameProvider
{
    ...
    internal void ProcessFrame(Frame frame, Intel.RealSense.FrameSource src)
    {
        try
        {
            if (!Streaming)
